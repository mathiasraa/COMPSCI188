...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        closestGhost = min(ghostPositions, key=lambda ghostPosition: getDistance(pacmanPosition, ghostPosition))
        action = min(legal, key=lambda action: getDistance(Actions.getSuccessor(pacmanPosition, action), closestGhost))
