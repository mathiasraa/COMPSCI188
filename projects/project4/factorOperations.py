...
def joinFactors(factors: List[Factor]):
    ...
    for factor in factors:
        ...
        conditioned += [
            var for var in factor.conditionedVariables() if var not in conditioned
        ]
...
def eliminateWithCallTracking(callTrackingList=None):
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        unconditioned = [
            var for var in factor.unconditionedVariables() if var != eliminationVariable
        ]
        conditioned = factor.conditionedVariables()

        variableDomainsDict = factor.variableDomainsDict()
        eliminatedFactor = Factor(unconditioned, conditioned, variableDomainsDict)
        ...
        for assignment in eliminatedFactor.getAllPossibleAssignmentDicts():
            ...
            for value in domain:
                ...
                probability += factor.getProbability(oldAssignment)
