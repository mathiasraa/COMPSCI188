...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        return max(qValues)[1] if qValues else None
    ...
    def getAction(self, state):
        ...
        return randomAction if prob else bestAction
    ...
    def getQValue(self, state, action):
        ...
        return sum(
            [
                ...
                for feature, value in self.featExtractor.getFeatures(
                    state, action
                ).items()
            ]
        )
